/*
* CSC 4710 Hierarchical Modeling base code (could also be used for Program 2).
* Includes modifications to shape and initGeom in preparation for loading
* multi-shape objects.
* Originally created by: Z. Wood, S. Sueda, I. Dunn
    */
